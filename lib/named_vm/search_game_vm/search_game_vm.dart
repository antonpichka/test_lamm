...
final class SearchGameVM {
  ...
  void _choiceInNavigation(int number) {
    ...
    if(isWhereEqualsTwoFromNumber) {
      _firstQQChoiceInNavigationQQIsWhereEqualsTwoFromNumber();
      return;
    }
  }
  ...
  void _choiceInAcceptanceMode(int number) {
    ...
    final isWhereEqualsOneFromNumber = _namedStreamWState
        ...
        .isWhereEqualsOneFromNumber(number);
    if(isWhereEqualsOneFromNumber) {
      _firstQQChoiceInAcceptanceModeQQIsWhereEqualsOneFromNumber(searchGame);
      return;
    }
    final isWhereEqualsTwoFromNumber = _namedStreamWState
        .getDataForNamed
        .isWhereEqualsTwoFromNumber(number);
    if(isWhereEqualsTwoFromNumber) {
      _firstQQChoiceInAcceptanceModeQQIsWhereEqualsTwoFromNumber(searchGame);
      return;
    }
  }
  ...
  void _firstQQChoiceInAcceptanceModeQQIsWhereEqualsOneFromNumber(SearchGame searchGame) {
    ...
    if(isWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy) {
      _firstBranchOneQQChoiceInAcceptanceModeQQIsWhereEqualsOneFromNumber();
      return;
    }
    _namedStreamWState.notifyStreamDataForNamed();
  }

  void _firstQQChoiceInAcceptanceModeQQIsWhereEqualsTwoFromNumber(SearchGame searchGame) {
  ...
  Future<void> _waitingInAcceptanceWEnemy() async {
    await Future.delayed(Duration(seconds: 5));
    final searchGame = _namedStreamWState
        .getDataForNamed
        .searchGame;
    ...
    final isWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy = _namedStreamWState
        ...
        .isWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy();
    if(isWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy) {
      _firstQQWaitingInAcceptanceWEnemyQQIsWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy();
      return;
    }
    _namedStreamWState.notifyStreamDataForNamed();
  }

  void _firstBranchOneQQChoiceInAcceptanceModeQQIsWhereEqualsOneFromNumber() {
  ...
  void _firstQQWaitingInAcceptanceWEnemyQQIsWhereTrueParametersIsAcceptedAndIsAcceptedWEnemy() {
    final userWUsername = _namedStreamWState
        .getDataForNamed
        .userWUsername;
    final userWUsernameWEnemy = _namedStreamWState
  ...
  void _firstQQChoiceInNavigationQQIsWhereEqualsTwoFromNumber() {
