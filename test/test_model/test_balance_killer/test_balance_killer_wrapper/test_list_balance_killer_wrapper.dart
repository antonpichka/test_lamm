...
import 'package:test_lamm/model/balance_killer/balance_killer_wrapper/list_balance_killer_wrapper.dart';

void main() {
  test("createListModel", () {
    final listBalanceKillerWrapper = ListBalanceKillerWrapper([
      [
    ...
    final createListModel = listBalanceKillerWrapper.createListModel();
    expect('ListBalanceKiller(listModel: [\n'
