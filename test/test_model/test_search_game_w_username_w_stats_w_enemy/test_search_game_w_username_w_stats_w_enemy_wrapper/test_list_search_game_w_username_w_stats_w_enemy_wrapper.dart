...
import 'package:test_lamm/model/search_game_w_username_w_stats_w_enemy/search_game_w_username_w_stats_w_enemy_wrapper/list_search_game_w_username_w_stats_w_enemy_wrapper.dart';

void main() {
  test("createListModel", () {
    final listSearchGameWUsernameWStatsWEnemyWrapper = ListSearchGameWUsernameWStatsWEnemyWrapper([
      [
