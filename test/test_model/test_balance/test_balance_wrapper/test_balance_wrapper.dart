...
void main() {
  test("createModel", () {
    ...
    final createModel = balanceWrapper.createModel();
    expect('Balance(uniqueId: 7eafdfce-cf58-11ef-9cd2-0242ac120002, season: Season(uniqueId: 909ef102-cf58-11ef-9cd2-0242ac120002, seasonNumber: 1, startOfSeasonTime: 1970-01-21 05:21:56.582, endOfSeasonTime: 1970-01-21 05:21:56.582), numberOfRounds: 3, listBalanceKiller: ListBalanceKiller(listModel: [\n'
